...
この章では、ソフトウェア要求プロセスの後続の5つのトピック*1の導入部を紹介し、ソフトウェア要求プロセスがどの様にソフトウェア・エンジニアリングプロセス全体の整合性を担保するかを説明する。  
*1・・・プロセスモデル,プロセスアクター,プロセスサポート＆マネジメント,プロセス品質＆改善
...
このプロセスは、基本的に学際的であり、各ステークホルダーのドメイン間で、要求の専門家及びそのドメインを専門とするソフトウェアエンジニアが介在することが必要である。  
